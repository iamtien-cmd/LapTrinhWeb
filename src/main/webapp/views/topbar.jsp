...
<c:choose>
    <c:when test="${sessionScope.account == null}">
        <div class="col-sm-6">
            <ul class="list-inline right-topbar pull-right">
                <li><a href="${pageContext.request.contextPath}/views/login">Đăng nhập</a> | 
                    <a href="${pageContext.request.contextPath}/views/register">Đăng ký</a>
                </li>
    ...
    <c:otherwise>
    <div class = "col-sm-6">
    <ul class = "lít-inline right-topbar pull-right">
    <li><a href = "${pageContext.request.contextPath}/member/myaccount"></a>
