...
public class MultiPartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.print(uploadPath + File.separator + fileName);
            boolean isSuccess = service.updateProfile(u.getUserName(),fullname,phone,uploadPath + File.separator + fileName);
            if (isSuccess){
